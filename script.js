...
function toggleLanguage() {
    const newLang = AppState.currentLang === 'en' ? 'fa' : 'en';
    setLanguage(newLang);
...
function setLanguage(lang) {
    ...
    if (lang === 'fa') {
        ...
        body.setAttribute('data-lang', 'fa');
...
function updateLanguageUI() {
    const textElements = document.querySelectorAll('[data-text-en], [data-text-fa]');
    textElements.forEach(element => {
        const enText = element.getAttribute('data-text-en');
        const arText = element.getAttribute('data-text-fa');
        if (AppState.currentLang === 'fa' && arText) {
    ...
    placeholderElements.forEach(element => {
        ...
        if (AppState.currentLang === 'fa' && arPlaceholder) {
    ...
    if (langToggle) {
        ...
        if (langText) {
            langText.textContent = AppState.currentLang === 'en' ? 'FA' : 'EN';
        }
    }
}
...
function handleFormSubmit(e) {
    ...
    const message = AppState.currentLang === 'fa' 
